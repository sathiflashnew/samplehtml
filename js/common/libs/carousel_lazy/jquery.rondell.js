...
(function($) {
  ...
  Rondell = (function() {
    ...
    Rondell.prototype._start = function() {
     ...
     var  parentContainer1 = this.container.parent();
   // alert(parentContainer1.attr('id'));
      if(parentContainer1.attr('id')=="rondellCarousel1"){
      		this.visibleItems=1;
      		//alert("dd");
      	}
        else{
...
var prev=1;
$("#pagin_"+prev).css("cursor","default");
var cur=1;
    Rondell.prototype.shiftTo = function(idx, keepOrder) {
        cur=idx;
    	$("#pagin_"+prev).removeClass("active");
    	$("#pagin_"+prev).css("cursor","pointer");
    	$("#pagin_"+idx).addClass("active");
    	$("#pagin_"+idx).css("cursor","default");    	
    	prev=idx;
...
(function($) {
  ...
  return $.rondell.RondellItem = (function() {
    ...
    RondellItem.prototype.onAnimationFinished = function() {
      this.animating = false;
      if (this.focused) {
      //	alert(carouselfirstLoad);
      	if(carouselfirstLoad){
      		//fnShowPopup(this.id);
      	}
